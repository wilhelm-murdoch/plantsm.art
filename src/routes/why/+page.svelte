		...
		<div class="overflow-hidden bg-white shadow-lg mb-4 pb-8 rounded-lg">
			...
			<div class="prose prose-lg prose-slate px-4 mx-auto text-gray-500 mb-8">
				...
				<p class="text-xl leading-8 text-gray-500 text-justify">
					Simply put, I love plants and I love animals. I can't count how many times I've been to a
					plant nursery and had to stop and do a Google search to see if something was safe enough
					to bring home and keep around our little Pandora, or 🐼 for short.
				</p>
			</div>

			<div class="grid grid-cols-3 mb-8">
				<img class="w-full object-cover" src="/images/why/panda-6.png" alt="" />
				<img class="w-full object-cover" src="/images/why/panda-2.png" alt="" />
				<img class="w-full object-cover" src="/images/why/panda-7.png" alt="" />
			</div>

			<div class="prose prose-lg prose-slate px-4 mx-auto text-gray-500 mb-8">
				<h3>It's as simple as that?</h3>
				<p>
					That was the idea, at least. I just wanted a single place that had all the information I
					needed so I could make informed purchasing decisions. I also figured I couldn't possibly
					be the only person who has this problem. So, I set off to make this project during the
					holiday break of 2022.
				</p>
				...
				<ul>
					<li>
						Must keep operational costs as close to zero as possible. The only money I've put down
						on this so far is the $20 AUD to purchase the domain name.
					</li>
					<li>
					...
					<li>
						Must be completely static. There should be no server-side rendering, processing or other
						explicit backend dependencies to manage. For this, I use the pre-rendering functionality
						that comes packaged with <a href="https://kit.svelte.dev/" title="SvelteKit"
							>SvelteKit</a
						>. I've been working with this for only a few weeks now and I'm a full convert.
					</li>
					<li>
						All data must be served statically as well. The entirety of the data set is contained
						within a single JSON file, which you can view at <a
							href="https://plantsm.art/plants.json"
							title="The primary Plant Smart data set.">/plants.json</a
						>. This is the source of truth for all derivative data sets and lookup tables used on
						this site. It's effectively what I call a "dumb API". Check out the
						<a href="/api" title="Plant Smart API documentation.">API documentation</a> if you'd like
				...
				<p>
					So far, it's going quite well. I haven't had any issues with meeting any of these
					self-imposed development constraints.
				</p>
				<h4>Any Caveats?</h4>
				<p>
					Definitely. The most obvious one would be image storage which has a direct effect on not
			...
			<div class="grid grid-cols-3 mb-8">
				<img class="w-full object-cover" src="/images/why/panda-1.png" alt="" />
				<img class="w-full object-cover" src="/images/why/panda-4.png" alt="" />
				<img class="w-full object-cover" src="/images/why/panda-5.png" alt="" />
			</div>
			...
			<div class="prose prose-lg prose-slate px-4 mx-auto text-gray-500 mb-8">
				...
				<ol>
					...
					<li>
						<a href="https://www.aspca.org/" title="ASPCA">ASPCA</a> was used to initially prime the
						first dataset. This is also where I sourced most of the common name and symptom data.
					</li>
					<li>
						<a href="https://en.wikipedia.org/wiki/Plant" title="Wikipedia">Wikipedia</a> is the best
						source of scientific classification data out there.
					</li>
				</ol>
				<p>
					All of this disparate data was collated and munged together by several processing scripts
					written in <a href="https://go.dev/" title="Golang's main site.">Go</a> as
					<a href="https://magefile.org/" title="Magefiles' main site.">Magefiles</a>. It got me
					about 95% there, but it still needs quite a bit of handraulic finessing.
				</p>
				...
				<p>
					...
					for a while longer. However, I do have other things planned for the future and will be
					using what I've learned here as a kind of launching pad.
				</p>
				<p>
					I sincerely hope you find <span class=" text-amber-400 mr-1 font-serif font-bold"
						>Plant</span
					>🌱<span class="text-green-600 italic font-serif font-bold">Smart</span> as useful as I had
					fun making it.
				</p>
			</div>
		</div>
