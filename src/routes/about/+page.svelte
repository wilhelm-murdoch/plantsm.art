<div class="relative bg-gray-50 mb-8 sm:px-6 sm:pt-4 lg:px-8 lg:pt-4 lg:pb-4 border-y">
	<div class="relative mx-auto max-w-7xl">
		<div class="overflow-hidden rounded-lg shadow-lg mb-8 bg-white p-10">
			<div class="mx-auto max-w-prose text-lg">
				<h1>
					<span class="block text-center text-lg font-semibold text-green-600">Introducing</span>
					<span
