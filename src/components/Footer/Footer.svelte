<footer class="mx-auto max-w-7xl overflow-hidden py-4 sm:px-6 lg:px-8">
	<nav class="-mx-5 -my-2 flex flex-wrap justify-center mb-8" aria-label="Footer">
		<div class="px-5 py-2">
			<a
				href="/"
				class="text-base inline-flex items-center rounded-md bg-black px-2.5 py-0.5 font-medium text-white align-middle"
			>
				<svg
	...
	<div class="text-center text-sm text-slate-300 mb-8">
		...
		<a
			...
			title="It me."
			class="font-semibold border-b hover:text-slate-400">wilhelm</a
		>
		<img
