		...
		<nav class="py-4 flex text-center md:text-left">
			...
			<div class="flex-2 space-x-2 hidden md:inline-block">
				<a
					...
					title="Twitter"
					class="text-slate-300 hover:text-slate-400 inline-block align-middle border-r pr-4 border-r-slate-100"
				>
				...
				<a
					href="/updates"
					title="Updates"
					class="text-red-600 hover:text-red-500 inline-block align-middle"
				>
					<svg
						class="w-6 h-6"
						fill="currentColor"
