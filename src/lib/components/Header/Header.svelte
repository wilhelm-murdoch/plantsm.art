...
<div class="border-b border-b-slate-50 mb-8">
	<div class="relative mx-auto max-w-7xl">
		<nav class="lg:py-4 flex">
			<div class="flex-1 lg:space-x-6">
				<a
					href="/about"
				...
				<a
					href="/contribute"
					class="border-b border-dotted border-b-green-600 hover:border-b-green-800 text-green-600 hover:text-green-500 font-medium"
					>Contribute</a
				>
			...
			<div class="flex-2 lg:space-x-4">
				<a
					href="https://twitter.com/wilhelm"
					title="Twitter"
					class="text-slate-300 hover:text-slate-400 inline-block align-middle border-r pr-4"
				>
				...
				<a
					href="https://github.com/wilhelm-murdoch"
					title="GitHub"
					class="text-slate-300 hover:text-slate-400 inline-block align-middle border-r pr-4"
				>
				...
				<a
					href="https://ko-fi.com/devilmaycode"
					title="Ko-fi"
					class="text-slate-300 hover:text-slate-400 inline-block align-middle"
				>
