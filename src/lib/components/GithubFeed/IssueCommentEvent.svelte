...
<li class="relative py-2">
	<div class="flex items-center mb-1">
		...
		/>
		<div
			class="absolute rounded-full p-1 text-{eventIcons.IssueCommentEvent[0]}-800 bg-{eventIcons
				.IssueCommentEvent[0]}-100"
			aria-hidden="true"
		>
			<svg
				class="w-6 h-6"
				...
				viewBox="0 0 24 24"
				stroke="currentColor"
				xmlns="http://www.w3.org/2000/svg">{@html eventIcons.IssueCommentEvent[1]}</svg
			>
		</div>
